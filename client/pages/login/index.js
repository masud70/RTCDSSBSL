                    ...
                    <div className='h-full bg-slate-600'>
                        ...
                        <div className='h-2/4 justify-center align-middle items-center flex'>
                            <Box
                                ...
                                >
                                    <div className=''>
                                        <TextField value={phone} onChange={e=>onChangePhone(e.target.value)} label="Phone" id="outlined-size-small" size="small"/>
                                        <TextField value={password} onChange={e=>onPasswordChange(e.target.value)} label="Password" id="outlined-size-small" size='small'/>
                                    </div>
                            </Box>
                        </div>
